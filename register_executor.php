				...
				if ($isInputEmpty == false) {
					...
					if ($_POST["password"] == $_POST["password_for_check"]) {									
						...
						try {
							...
							$query = $conn->prepare('INSERT INTO executor (mail, firm_title, surname, name, patronymic, password) 
													 VALUES (:mail, :firm_title, :surname, :name, :patronymic, :password)');						
							...
							$query->bindValue(':firm_title', $firm_title);
							$query->execute();
	...
	<body>
		<div align="center">
			...
			<form method="post">
				...
				Название фирмы:
				<br>
				<input type="text" name="firm_title">
				<br>
				Фамилия:
				<br>
